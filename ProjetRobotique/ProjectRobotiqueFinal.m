...
K_P = 2.5; % Ganho proporcional, ainda nao sei se ta certo
...
robot = [v_max a_max];
qi = [-pi; -pi/2; -pi/2; -pi; -pi/2; -pi];  % Posição inicial
...
delta_t = 0.01; % Intervalo de tempo para integração
iteration = 0;
max_iterations = 1000;
...
while iteration < max_iterations
    ...
    q_dot_limited = min(q_dot, q_values); % Limitar com o valor máximo calculado pela Lei do Trapézio
