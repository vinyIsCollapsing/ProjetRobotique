function [joint_positions, P_e] = MGD(alpha, r, theta, d)
    % MGD - Calcula a posição de cada junta do robô e retorna P_e
    ...
    % Store the initial position (base position)T
    ...
    % Extract P_e from the last column of T_base_to_joint
